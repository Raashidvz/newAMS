    ...
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="course" name="course" value="<?php echo $stud['CLASS_NAME']; ?>" required>
            </div>
        ...
        <?php
            if(isset($_POST['update'])){
                ...
                $sql2="UPDATE students SET NAMEE='$name',CLASS_NAME='$course',PARENT_CONTACT='$contact' WHERE USER_ID='$user_id'";
