...
if(isset($_POST['place_order'])){
    ...
    $sql="UPDATE orders SET STATUSES='PENDING', ESTIMATED_DELIVERY_DATE='$estimate_date', ACTUAL_DELIVERY_DATE='$actual_date',CREATED_AT='$currentDateTime' WHERE ORDER_ID='$_SESSION[ORDER_ID]'";
    $data=mysqli_query($dbcon,$sql);
    if($data){
